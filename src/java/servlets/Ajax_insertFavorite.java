 ...
 * @author Indunil
 */
public class Ajax_insertFavorite extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(favorite.addFavorite(login,itemNumber)){
                myObj.addProperty("favorite_added", true);
            }else{
                myObj.addProperty("favorite_added", false);
            }
