...
import classes.UserFavorite_Class;
 ...
 * @author Indunil
 */
public class Ajax_removeFavorite extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(favorite.removeFavorite(login,itemNumber)){
                myObj.addProperty("favorite_removed", true);
            }else{
                myObj.addProperty("favorite_removed", false);
            }
