 ...
 * @author Indunil
 */
public class Ajax_deleteConversation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String user = getLogin(request);
            String party = request.getParameter("partner");
            ...
            myObj.addProperty("Delete", msg.deleteConversation(user, party));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Ajax_deleteConversation.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
