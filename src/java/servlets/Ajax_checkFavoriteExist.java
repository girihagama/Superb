 ...
 * @author Indunil
 */
public class Ajax_checkFavoriteExist extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(favorite.checkSaved(login,itemNumber)){
                myObj.addProperty("favorite_exist", true);
            }else{
                myObj.addProperty("favorite_exist", false);
            }
